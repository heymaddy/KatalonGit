...
WebUI.click(findTestObject('OB_005_Login screen_fms smart/login screen/username'))

WebUI.setText(findTestObject('OB_005_Login screen_fms smart/login screen/username'), username)

WebUI.click(findTestObject('OB_005_Login screen_fms smart/login screen/Password'))

WebUI.setText(findTestObject('OB_005_Login screen_fms smart/login screen/Password'), password)
