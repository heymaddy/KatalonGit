...
WebUI.verifyElementClickable(findTestObject('OB_001_Login screen/Login Screen/button_Sign in'))

WebUI.verifyElementClickable(findTestObject('OB_001_Login screen/Login Screen/Password'))

WebUI.verifyElementClickable(findTestObject('OB_001_Login screen/Login Screen/Username'))
...
WebUI.waitForElementVisible(findTestObject('OB_004_Logout Feature/logout feature/a_IOCL'), 15)

WebUI.click(findTestObject('OB_004_Logout Feature/logout feature/a_IOCL'))

WebUI.click(findTestObject('OB_004_Logout Feature/logout feature/button_Logout'))

WebUI.verifyElementVisible(findTestObject('OB_001_Login screen/Login Screen/button_Sign in'))
